<%-- 
    Document   : ShowCustOrder
    Created on : 5-Dec-2014, 12:46:45 PM
    Author     : hiral
--%>
...
<html>
    ...
    <body>
        ...
        <table border="1" style="border-collapse: collapse">
         ...
         <c:forEach var="theElement" items="${CustomerOrder}" >
             <tr>
             ...
             <tr>
                 <td colspan="5" style="text-align: right">Total Sale of this Customer</td>
                 <td>${tPrice}</td>
             </tr>
        </table>
